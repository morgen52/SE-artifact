...
TODO
1. how is "average" calculated in tables?
2. optimize plot style
...
def figure_ratio_with_artifact(filename):
    ...
    df.rename(columns={True: "With Artifact", False: "Without Artifact"}, inplace=True)
...
def figure_methodology_overview(filename):
    """
...
def figure_artifact_by_programming_language(filename):
    ...
    fig, ax = plt.subplots(figsize=(5, 5))
    draw_stacked_bar_chart(df, ax, programming_languages, "count")
...
def figure_url_location(filename):
    """
    Figure 5: Distribution of artifact locations and formats of URLs
    provided in a paper
    """
...
def figure_invalid_url_ratio_by_storage_website(filename):
    ...
    """
    print("Not implemented...")
    # TODO: ask how to determine storage type
